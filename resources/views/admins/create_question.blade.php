    ...
    <div class="max-w-7xl m-4 mx-auto sm:px-6 lg:px-8">
        <div class="bg-white mt-4 overflow-hidden shadow-xl sm:rounded-lg">
            <div class="mx-auto bg-green-200">
                <h2 class="text-2xl font-bold card bg-green-600 p-4 text-gray-100 rounded-t-lg mx-auto">Câu hỏi mới</h2>
                <div class="mt-2 max-w-auto mx-auto card p-4 bg-white rounded-b-lg shadow-md">
                    <div class="grid grid-cols-1 gap-6">
                        <form action="{{route('storeQuestion', $section)}}" method="post">
                            @csrf
                            <label class="block">
                                <span class="text-gray-700">Câu hỏi</span>
                                @error('question')
                            ...
                            <label class="block">
                                <span class="text-gray-700">Giải thích</span>
                                @error('explanation')
                                <span class="text-red-700 text-xs content-end float-right">{{$message}}</span>
                                @enderror
                            ...
                            <label class="block">
                                <span class="text-gray-700">Câu hỏi này có hoạt động không?</span>
                                @error('is_active')
                                <span class="text-red-700 text-xs content-end float-right">{{$message}}</span>
                                @enderror
