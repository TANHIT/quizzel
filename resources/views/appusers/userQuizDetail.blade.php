        ...
        <div class="bg-white border-2 border-gray-300 shadow overflow-hidden sm:rounded-lg">
            <div class="px-4 py-5 sm:px-6">
                ...
                <p class="mt-1 max-w-2xl text-sm text-gray-700">
                    ...
                    Bạn đã làm bài kiểm tra này {{$userQuizDetails->updated_at->diffForHumans()}} vào <span class="text-bold bg-green-300 px-2 rounded-lg"> {{$userQuizDetails->updated_at}} </span>
                </p>
            </div>
            <div class="border-t border-gray-300">
                <dl>
                    ...
                    <div class="bg-white px-4 py-2 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                        ...
                        <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                            {{$userQuizDetails->completed ? 'Hoàn thành' : 'Không hoàn thành'}}
                        </dd>
                    </div>
                    <div class="bg-gray-50 px-4 py-2 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                        <dt class="text-sm font-medium text-gray-700">
                            Tổng số câu hỏi bài kiểm tra
                        </dt>
                        <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
